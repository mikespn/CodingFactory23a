...
public class MobileApp {
                ...
                try{
                    ...
                    switch(choice){
                        ...
                        case 5:
                            ...
                            System.out.println("Επιτυχής εκτύπωση");
                            break;
                        default:
    ...
    public static void updateController(String firstname, String lastname,
        ...
        try{
            ...
            if(newPhoneNumber.length() < 2 || newPhoneNumber.length() >12){
                throw new IllegalArgumentException("new Phone is not Valid");
            }
...
//        contact[2] = contacts[positionToUpdate][2];
        ...
        contacts[positionToUpdate][2] = firstname;
//        return contact;
        return true;
    }
    ...
    public static String[] delete(String phoneNumber){
        ...
        System.arraycopy(contacts[positionToDelete], 0, contact, 0, contact.length + 1);
